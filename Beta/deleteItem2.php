...
$to = $email;
$subject = "Extra! - \"" . $title . "\" has been removed.";
$body = "
<html>
<head>
<title>Extra! - \"" . $title . "\" as been removed.</title>
...
<p>Hello, " . $name . ",\nYour item  \""
. $title . "\" has been removed.<br><br>Here is the message the moderator sent about your item:<br><br>
            </p>
...
<p>Here is the item that was removed
