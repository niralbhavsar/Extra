...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="main">
                <div class="row">
                    <h3 class="page-header">Confirm Item Deletion</h3>
                    <div class="col-sm-6">
                        <?php
                        require_once("scripts/db.php");
                ...
                <!--                        <img src="data:image/jpeg;base64,<?php echo $image; ?>" class="img-rounded" height ="100" width="100" alt="<?php echo $title; ?>"/>-->
                    ...
                    <div class="col-sm-6">
                        <form name="deleteItem" action="deleteItem2.php" method="POST">
                            ...
                            <textarea rows="6" cols="60" class="form-control" id="message" name="message" placeholder="Why is this item being deleted?"></textarea>
                            <br>
                            <input type="submit" id="Deny" name="Deny" class="btn btn-lg btn-danger" value="Delete Item and Notify Seller">
                        </form>
                    </div>
                </div>
            </div>
