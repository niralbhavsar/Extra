...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="main">
                <h3 class="page-header">Confirm Item Approval</h3>
            ...
            <!--                        <img src="data:image/jpeg;base64,<?php echo $image; ?>" class="img-rounded" height ="100" width="100" alt="<?php echo $title; ?>"/>-->
                ...
                <div class="col-sm-6">
                    <form name="approveItem" action="approveItem.php" method="POST">
                        ...
                        <textarea rows="6" cols="60" class="form-control" id="message" name="message" placeholder="Send a message to the seller."></textarea>
                        <br>
                        <input type="submit" id="Approve" name="Approve" class="btn btn-lg btn-success" value="Approve Item and Notify Seller">
                    </form>
                </div>
            </div>
