...
<div class="tab-content">
    <div class="tab-pane active" id="manage">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="list-group">
                    ...
                    <a href="#" id="link3"class="list-group-item">Morbi leo risus</a>
                    <a href="#" id="link4"class="list-group-item">Porta ac consectetur ac</a>
                    <a href="#" id="link5"class="list-group-item">Vestibulum at eros</a>
        ...
        <div id="info3">Info3 content</div>
        <div id="info4">Info4 content...</div>
        <div id="info5">Info5 content...</div>
    </div>
</div>
