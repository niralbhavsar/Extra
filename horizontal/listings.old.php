            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Arts and Entertainment<b class="caret"></b></a>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <a href="sellPage.php" <button type="submit" class="btn btn-success" id="signin">Sell!</button></a>
       

                    <h2>Premium Items</h2>
                    <div class="row" style="background-color:#FFFFCC">
                        <div class="col-md-6"><a href="itempage.php"><img src="images/painting.jpg" class="img-rounded premium_thumb" style="max-height: 400px;  max-width: 400px; height:auto; width: auto;" /><br />Beautiful Painting</a></div>
                        <div class="col-md-6"><a href="itempage.php"><img src="images/ps3game.jpg"  class="img-rounded premium_thumb" style="max-height: 400px;  max-width: 400px; height:auto; width: auto;" /><br />PS3 Game</a></div>
                    </div>
                    <h2>Items</h2>
                    <div class="row">
                        <div class="col-md-4"><a href="itempage.php"><img src="images/macbook.jpg" class="img-rounded img_thumb" style="max-height: 300px;  max-width: 300px; height:auto; width: auto;"/><br />Macbook Pro</a></div>
                        <div class="col-md-4"><a href="itempage.php"><img src="images/bmwmotorcycle.jpg" class="img-rounded img_thumb" style="max-height: 300px;  max-width: 300px; height:auto; width: auto;"/><br />BMW Motorcycle</a></div>
                        <div class="col-md-4"><a href="itempage.php"><img src="images/datastructs.jpg" class="img-rounded img_thumb" style="max-height: 300px;  max-width: 300px; height:auto; width: auto;"/><br />Data Structures Book</a></div>
                    </div>
                    <!-- END CONTENT -->
             <!--
                    |
